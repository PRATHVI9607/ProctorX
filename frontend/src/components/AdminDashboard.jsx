...
export default function AdminDashboard({ onLogout }) {
  ...
  return (
    <div className="page-container">
      ...
      >
        <div>
          ...
          <div style={{ fontSize: "0.8rem", opacity: 0.8 }}>
            Manage sections, questions, exams & live monitoring.
          </div>
        </div>
      ...
      <div className="grid-2-tight" style={{ marginTop: "1.25rem" }}>
        ...
        <div className="card card-soft">
          <div className="section-title">
            <span>Exams & Live Sessions</span>
          </div>
          <div>
            <label style={{ fontSize: "0.75rem" }}>Select exam</label>
            <select
              className="input"
          ...
          {selectedExamId && (
            <>
              <h4 style={{ marginTop: "0.75rem", marginBottom: "0.4rem" }}>
                Live / Past Sessions
              </h4>
              <div className="table-wrapper">
                <table className="table">
